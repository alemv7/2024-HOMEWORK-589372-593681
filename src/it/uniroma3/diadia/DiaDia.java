...
public class DiaDia {
	...
	private void prendi(String nomeAttrezzo) {
		if (this.partita.getLabirinto().getStanzaCorrente().hasAttrezzo(nomeAttrezzo)) {
			...
			this.io.mostraMessaggio("Non è possibile prendere l'attrezzo desiderato \n");
		}
	}
	...
	private void posa(String nomeAttrezzo) {
		if (this.partita.getGiocatore().getBorsa().hasAttrezzo(nomeAttrezzo)) {
			...
			if (this.partita.getLabirinto().getStanzaCorrente().addAttrezzo(attrezzoPosa)) {
				io.mostraMessaggio("Hai posato: " + nomeAttrezzo);
			}else {
				io.mostraMessaggio("La stanza è piena, l'attrezzo non è stato posato");
				this.partita.getGiocatore().getBorsa().addAttrezzo(attrezzoPosa);
			}
		} else {
